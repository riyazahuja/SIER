...
def train(ticker, forecast_horizon, window_size, epochs=25, batch_size=32, training_split = 0.9):
    ...
    model.save(f'models/bin/{ticker}/{forecast_horizon}f_{window_size}w_model.keras')
    joblib.dump(scaler_features, f'models/bin/{ticker}/{forecast_horizon}f_{window_size}w_scaler_features.pkl')
    joblib.dump(scaler_target, f'models/bin/{ticker}/{forecast_horizon}f_{window_size}w_scaler_target.pkl')
